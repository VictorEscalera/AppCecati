...
@Component({
  ...
  standalone: true,
  imports: [IonInput, IonCard, IonContent, CommonModule, FormsModule, IonCardContent, IonCardHeader,
...
export class RegistroPage implements OnInit {
  ...
  ngOnInit() { }
  /* MONGO_URI=mongodb+srv://victorsolis2019:Tobivictor__11@cluster0.syaedri.mongodb.net/Login?retryWrites=true&w=majority
PORT=10000 */
